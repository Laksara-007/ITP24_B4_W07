...
import { createInventoryDetails, deleteInventory, getAllInventories, getAllRequestedStocks, getInventoryBYID, handleStockRelease, inventoryStats, requestPerItems, requestStocks, updateInventory } from '../controllers/inventory';
...
inventoryRoute.get('/statsItem', verifyAccessToken, verifyStaffMember, veryfyInventoryManager, requestPerItems);
