        ...
        {menu.map((item) => {
          return (
            <div className="max-w-[327px] w-full">
              <div className="max-h-[377px] min-h-[377px] h-[377px] w-[327px] max-w-[327px] min-w-[327px] bg-[#FFF2DE] flex flex-col items-left justify-end px-10">
                {/* <img
