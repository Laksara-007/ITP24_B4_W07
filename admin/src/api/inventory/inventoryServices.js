...
export const getInventoryReleaseStat = async() => {
  return await apiRequest(() => axiosInstance.get("/inventory/statsItem"))
}

export const requestPerDay = async () => {
  return await apiRequest(() => axiosInstance.get("/inventory/stats"))
}